...
**CASE WHEN** — writing IF/THEN logic in SQL, like categorizing members into satisfaction groups: Promoter, Neutral, At Risk, or Detractor
...
- **ValleyHealth Medicare** had the lowest scores and needed the most outreach
